...
export default function SiteFooter() {
  return (
    <footer className="overflow-hidden border-t border-gold-500/20 bg-midnight">
      <section id="newsletter" className="px-5 sm:px-6 py-12 md:py-16 bg-navy-800 grain-overlay stars-bg">
        <div className="max-w-6xl mx-auto grid min-w-0 lg:grid-cols-[1fr_1.1fr] gap-8 lg:gap-16 items-center">
          <div className="min-w-0">
            <p className="text-[10px] tracking-[0.4em] sm:tracking-[0.5em] text-gold-500 mb-4">STAY CONNECTED</p>
            <h2 className="font-serif text-[1.7rem] leading-tight md:text-3xl text-parchment-100 mb-4 text-balance break-words">
      ...
      <section className="px-5 sm:px-6 py-10 md:py-14">
        <div className="max-w-6xl mx-auto min-w-0">
          <div className="grid min-w-0 gap-10 lg:grid-cols-[1.1fr_2fr]">
            <div className="min-w-0">
              <Logo variant="footer" />
            ...
            <nav className="grid min-w-0 grid-cols-2 sm:grid-cols-4 gap-8 text-xs tracking-[0.12em] text-parchment-500">
